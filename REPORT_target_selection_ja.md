...
ユーザーの明示承認後、GitHubへのpushを完了し、#3ブランチに対する
[draft PR #6](https://github.com/wasanemon/exact_abort_selection/pull/6) として提出した。
PRのbaseは指定コミット `d150211968ef6d61efda82f9f44f63e3bac28b44`。自動mergeは行わない。
